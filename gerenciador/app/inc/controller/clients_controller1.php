	...
	public function display($info)
	{
		...
		switch ($info["format"]) {
			case ".autocomplete":
				...
				break;
			case ".xls":
				if( file_exists( constant("cFurniture1") . 'excel/Relatorio.xls' ) ){
					unlink( constant("cFurniture1") . 'excel/Relatorio.xls' ) ;
				}
				...
				$objWriter->save(constant("cFurniture1") . 'excel/Relatorio.xlsx');
				...
				ob_clean();
				flush();
				readfile(constant("cFurniture1") . 'excel/Relatorio.xlsx');
				unset($objPHPExcel);
				exit();
				break;
			case ".json":
