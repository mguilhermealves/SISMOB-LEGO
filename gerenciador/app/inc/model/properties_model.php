...
class properties_model extends DOLModel{
	protected $field = array( " idx " , " created_at " , " created_by " , " modified_at " , "modified_by " , " address " , " number_address " , " complement " , " code_postal " , " district ", " city " , " uf " , " type_propertie " , " object_propertie " , " deadline_contract " , " financial_propertie " , " financer_name ", "price_condominium", "price_location", "price_sale", "price_iptu", "porcent_propertie", "is_swap", "comments", "is_used", "imagem", "docs") ;
