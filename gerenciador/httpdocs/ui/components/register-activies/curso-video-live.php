<div class="tab-pane fade show active" id="curso-video-live" role="tabpanel" aria-labelledby="curso-video-live-tab">
    <!-- Descritivo de Atividade -->
    <?php include(constant("cFrontComponents") . "modelo/card_course_descript.php");  ?>

    <!-- Endereço do Curso -->
    <?php include(constant("cFrontComponents") . "modelo/card_link.php");  ?>
