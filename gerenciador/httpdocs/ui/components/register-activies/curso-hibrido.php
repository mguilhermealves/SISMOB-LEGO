<div class="tab-pane fade show active" id="curso-hibrido" role="tabpanel" aria-labelledby="curso-hibrido-tab">
    ...
    <!-- Coffee Brake -->
    <?php include(constant("cFrontComponents") . "modelo/card_coffee_brake.php");  ?>

    <!-- Registers and Moviments -->
    <?php include(constant("cFrontComponents") . "modelo/card_times_and_moviments.php");  ?>
    
    <!-- infrastructure -->
    <?php include(constant("cFrontComponents") . "modelo/card_infrastructure.php");  ?>
