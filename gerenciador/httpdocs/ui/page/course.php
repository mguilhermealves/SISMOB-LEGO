<div class="row">
    <p class="mb-0 col-lg-12">
        <a href="<?php print( $GLOBALS["home_url"] ) ?>">Home</a> / <a href="<?php print( $GLOBALS["courses_url"] ) ?>">Cursos</a> / <?php print( $form["title"] ) ?></p>
    <div class="container-fluid box solaris-head">
        <form action="<?php print( $form["url"] ) ?>" method="post" enctype="multipart/form-data" >
                        ...
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label for="course_title">Nome</label>
                                    <input placeholder="Nome do Curso" id="course_title" type="text" class="form-control"  name="course_title" value="<?php print( isset( $data["course_title"] ) ? $data["course_title"] : "" ) ?>">
                                </div>                    
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label for="display_position"> Posição </label>
                                    <input placeholder="Ordenação do Curso na Trilha" id="display_position" type="text" class="form-control"  name="display_position" value="<?php print( isset( $data["display_position"] ) ? $data["display_position"] : "" ) ?>">
                                </div>       
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group">
                            ...
                            <div class="col-lg-6">                    
                                <div class="form-group">
                                    ...
                                    <textarea placeholder="Texto de Apresentação do Curso" style="height: 252px;" id="course_resume" name="course_resume" class="form-control" ><?php print( isset( $data["course_resume"] ) ? $data["course_resume"] : "" ) ?></textarea>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label for="thumbnail">Imagem <small>(380px x 175px)</small> </label>
                                    <input type="file" id="thumbnail" name="thumbnail"  />                        
                                </div>
                                <?php if( !empty( $data["course_img_url"] ) && file_exists( constant("cRootServer") . $data["course_img_url"] ) ){
                                    ?><img class="img-fluid my-4" src="/<?php print( $data["course_img_url"] ) ?>"/>
                                <?php } ?>   
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2">
                                <div class="form-group">
                                    ...
                                    <input placeholder="Apresentação da duração total do curso" id="course_duration" type="text" class="form-control"  name="course_duration" value="<?php print( isset( $data["course_duration"] ) ? $data["course_duration"] : "" ) ?>">
                                </div>                       
                            </div> 
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label for="credits_value">Créditos Educacional Valor </label>
                                    <input placeholder="Utilizado para valores de créditos educacionais" id="credits_value" type="text" class="form-control"  name="credits_value" value="<?php print( isset( $data["credits_value"] ) ? $data["credits_value"] : "" ) ?>">   
                                </div> 
                            </div> 
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label for="credits_text">Créditos Educacional Texto </label>  
                                    <input placeholder="Utilizado para classificar créditos educacionais"  id="credits_text" type="text" class="form-control"  name="credits_text" value="<?php print( isset( $data["credits_text"] ) ? $data["credits_text"] : "" ) ?>">
                                </div> 
                            </div> 
                        </div>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <a href="<?php print( $form["done"] ) ?>" class="round hollow button secondary" >Voltar</a>
                </div>
