    ...
    <div class="col-lg-12" style="overflow: auto;">
        <table class="table table-striped table-inverse table-hover">
            <thead class="thead-inverse">
                <tr>
                    <th><a style="color:#707070;text-decoration:none" href="<?php print(set_url($form["search"], array("ordenation" => $ordenation_name))) ?>">Nome da Turma <i class="<?php print($ordenation_name_ordenation) ?>"></i></a></th>
                    <th>Ações</th>
                </tr>
            </thead>
            <tfoot>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a class="btn button btn-info" href="<?php printf( $form["action"] , $v["idx"] ) ?>">[ editar ]</a> 
                        <!--a id="btn_remove_<?php print( $v["idx"] ) ?>" class="btn button btn-danger" href="<?php printf( $form["action"] , $v["idx"] ) ?>">[ excluir ]</a-->
                    </td>
                </tr>
                <?php } ?>
            </tbody>
