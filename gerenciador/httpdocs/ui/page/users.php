            ...
            <table class="table">
               <thead>
                  <tr>
                     ...
                     <th>
                        <a style="color:#707070;text-decoration:none" href="<?php print(set_url($form["pattern"]["search"], array("ordenation" => $ordenation_login))) ?>">Login <i class="<?php print($ordenation_login_ordenation) ?>"></i></a>
                     </th>
                     <th>
                        Grupo
                     </th>
               ...
               <tbody>
                  ...
                  ?>
                     <tr>
                        ...
                        <td>
                           <a class="btn btn-primary mx-2" href="<?php printf($form["pattern"]["action"], $value["idx"]) ?>" class="button tiny bg-blue round" title="Detalhe">Detalhe <i class="fontello-edit"></i></a>
                        </td>
                     </tr>
                  <?php
                  }
