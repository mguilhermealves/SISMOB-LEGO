<!-- Container Begin -->
<div class="row">
    <p class="mb-0 col-lg-12"><a href="<?php print($GLOBALS["home_url"]) ?>">Home</a> / <a href="<?php print(set_url($info["get"]["done"])) ?>">Locações em Andamento</a> / <?php print($form["title"]) ?></p>
                            ...
                            <div class="container-fluid">
                                <div class="row">
                                    <div class="row col-lg-12">
                                        ...
                                        <div class="col-lg-4 is_apartmant">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group mb-3">
                                                    ...
                                                    <input type="text" id="price_condominium" name="price_condominium" value="<?php print(isset($data["properties_attach"][0]) ? $data["properties_attach"][0]["price_condominium"] : "") ?>" class="form-control" disabled>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group">
                                                <label for="qtd_payment_generator">Qtd de Pagamento Gerados</label>
                                                <input id="qtd_payment_generator" type="number" min="0" class="form-control" name="qtd_payment_generator" value="<?php print(isset($data["qtd_payment_generator"]) ? $data["qtd_payment_generator"] : "") ?>">
                                            </div>
                                        </div>
