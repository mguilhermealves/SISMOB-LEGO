<!-- Container Begin -->
<div class="row">
    <p class="mb-0 col-lg-6"><a href="<?php print($GLOBALS["home_url"]) ?>">Home</a> / Locações em Andamento</p>
        ...
        <table class="table table-striped table-inverse table-hover">
            ...
            <tbody>
                ...
                if ($total > 0) {
                    ...
                    <tr>
                        <td colspan="8">
                            <p class="alert alert-warning text-center">Nenhuma locação em andamento encontrada...</p>
                        </td>
                    </tr>
                <?php
                }
