    ...
    <div class="large-12 columns" >
        <div class="box solaris-header">
            <div class="box-header bg-transparent">
                <h3 class="box-title">
                    <span><?php print( isset( $info["idx"] ) && (int)$info["idx"] > 0 ? "Editar Programa de Relacionamento ". $data["name"] : "Cadastrar Programa de Relacionamento" ) ?></span>
                </h3>
            </div>
        </div>
                ...
                <form action="<?php print( $form["url"] ) ?>" method="post" enctype="multipart/form-data" >
                    ...
                    <div style="display: flex;justify-content: space-evenly;">
                        <div class="large-6 columns bxs_user">
                            ...
                            <div class="large-12 columns">
                                <label>
                                    Nome do Programa de Relacionamento
