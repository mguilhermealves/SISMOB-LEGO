        ...
        <div class="container-fluid box solaris-head">
            <div class="box-body">
                <form action="<?php print( $form["url"] ) ?>" method="post" enctype="multipart/form-data" >
                    ...
                    if( isset( $tests_id ) ){
                    ?>
                    <input type="hidden" id="tests_id" name="tests_id" value="<?php print( $tests_id  ) ?>">
                    <?php
                    }
                    ?>
                        ...
                        <div class="header" style="margin-bottom:30px">Dados</div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <label>
                                    Pontos</label>
                                        <input type="text" class="form-control"  name="points" value="<?php print( isset( $data["points"] ) ? $data["points"] : "" ) ?>">                                    
                                </div>
                                <div class="col-lg-4">
                                    <label>
                                    Tipo </label>
                    ...
                    <div style="display: flex;justify-content: space-evenly; padding-top:15px">
                        <div class="large-4 columns">
                            <a href="<?php printf($GLOBALS["test_url"] , $tests_id) ?>" class="round hollow button secondary" >Voltar</a>
                        </div>
...
<div class="row">
    <div class="large-12 columns" >
        <div class="box solaris-header">
            ...
            <a class="btn button bg-gray round" title="Incluir" href="<?php printf( $GLOBALS["newalternative_url"], $data["idx"] ) ?>"><i class="fontello-plus"></i>Nova Alternativa</a>

        </div>

        <?php if(isset($data["alternatives_attach"])){

               $alternatives = isset($data["alternatives_attach"]) ? $data["alternatives_attach"] : []; ?>
