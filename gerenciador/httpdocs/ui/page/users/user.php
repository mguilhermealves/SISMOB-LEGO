   ...
   <div class="container-fluid box solaris-head">
      ...
      <form id="form_opportunity_board" action="<?php print($form["url"]) ?>" method="post" enctype="multipart/form-data">
                  ...
                  <div class="row">
                     ...
                     <div class="col-sm-4">
                        <div class="form-group">
                           ...
                           <input id="cpf" <?php print(isset($data["idx"]) ? 'disabled' : '') ?> type="text" class="form-control" name="cpf" value="<?php print(preg_replace("/(.+)(...)(...)(..)$/", "$1.$2.$3-$4", preg_replace("/\D+?/", "", $data["cpf"]))) ?>" required>
                        </div>
                     </div>
                     ...
                     <div class="col-sm-4">
                        <div class="form-group">
                           ...
                           <input id="mail" <?php print(isset($data["idx"]) ? 'disabled' : '') ?> type="text" class="form-control" name="mail" value="<?php print(isset($data["mail"]) ? $data["mail"] : "") ?>" required>
                        </div>
                     </div>
                  ...
                  <div class="row">
                     <div class="col-sm-3">
                        <div class="form-group">
                           ...
                           <input id="created_at" disabled type="text" class="form-control" value="<?php print(isset($data["created_at"]) ? date_format(new DateTime($data["created_at"]), 'd/m/Y H:i:s') : "") ?>">
                        </div>
                     </div>
                     ...
                     <div class="col-sm-3">
                        <div class="form-group">
                           ...
                           <input id="last_login" disabled type="text" class="form-control" value="<?php print(isset($data["last_login"]) ? date_format(new DateTime($data["last_login"]), 'd/m/Y H:i:s') : "") ?>">
                        </div>
                     </div>
         ...
         <div class="col-lg-12 text-right">
            <button type="submit" name="btn_save" class="btn btn-primary btn-sm"><i class="bi bi-save"></i> Salvar</button>
         </div>
      </form>
   </div>
</div>
