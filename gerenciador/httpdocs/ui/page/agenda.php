    ...
    <div class="large-12 columns" >
        <div class="box solaris-header">
            <div class="box-header bg-transparent">
                <h3 class="box-title">
                    <span><?php print( isset( $data["title"] ) ? "Editar Agenda ". $data["title"] : "Cadastrar Agenda" ) ?></span>
                </h3>
            </div>
        </div>
                    ...
                    <div style="display: flex;justify-content: space-evenly; padding-top:15px">
                        <div class="large-12 columns bxs_user">
                            ...
                            <div class="large-6 columns padding-top-20">
                                <label>
                                    Data
                                    <input type="date"  name="date_event" value="<?php print( isset( $data["date_event"] ) ? preg_replace("/^(....).(..).(..).+$/","$1-$2-$3", $data["date_event"] ) : "" ) ?>">
                                </label>
                            </div>
