    ...
    <div class="large-12 columns" >
        ...
        <div class="box solaris-head">
            <div class="box-body">
                ...
                ?>
                <form class="large-12 columns" id="frm_filter" method="GET" action="<?php print( $GLOBALS["quizes_url"] ) ?>" style="display: flex;flex-direction: row;justify-content: space-around;align-items: flex-end;">
                        <label>
                            Nome
                        ...
                        <label>
                            Grupo
                            <input type="text"  name="filter_level" value="<?php print( isset( $info["get"]["filter_level"] ) ? $info["get"]["filter_level"] : "" ) ?>">
                        </label>
                        <div>
