        ...
        <div class="container-fluid box solaris-head">
            <div class="box-body">
                <form action="<?php print( $form["url"] ) ?>" method="post" enctype="multipart/form-data" >
                    ...
                    ?>
                    <input type="hidden" id="questions_id" name="questions_id" value="<?php print( $questions_id  ) ?>">
                    <?php
                    }
                    ?>
                    ...
                    <div style="display: flex;justify-content: space-evenly; padding-top:15px">
                        <div class="large-4 columns">
                            <a href="<?php printf($GLOBALS["question_url"] , $questions_id) ?>" class="round hollow button secondary" >Voltar</a>
                        </div>
