                    ...
                    <div class="row">
                        <div class="col-sm-9">
                            <div class="form-group">
                                ...
                                <input id="title" class="form-control" type="text" name="title" value="<?php print( isset( $data["title"] ) ? $data["title"] : "" ) ?>" placeholder="Escreva aqui o título">
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="resume" name="resume"  placeholder="Resumo da atividade" style="resize: none;"><?php print( isset( $data["resume"] ) ? $data["resume"] : "" ) ?></textarea>
                            </div>
                        </div>

                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="thumbnail">Adicione uma imagem</label>
                                <input type="file" class="form-control" id="thumbnail" aria-describedby="helpId" name="thumbnail">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="link" id="link" placeholder="http://" value="<?php print( isset( $data["link"] ) ? $data["link"] : "" ) ?>">
                            </div>
                        </div>
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="description" name="description" placeholder="Descrição completa da atividade" style="resize: none;"><?php print( isset( $data["description"] ) ? $data["description"] : "" ) ?></textarea>
                            </div>
                        </div>
                    </div>
                </div>
