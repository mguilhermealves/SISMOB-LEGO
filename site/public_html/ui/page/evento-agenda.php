                                    ...
                                    <div class="row padding-left-10 padding-right-10 margin-bottom-40 listagem-noticias">
                                        <div class="col-lg-6">                                            
                                            <div class="imagem-noticia">
                                                <img src="/<?php printf($agendas->data[0]["image"]) ?>" />
                                            </div>
                                        </div>
                                        <div class="col-lg-6 padding-left-35 resumo">
                                            <h2><?php printf($agendas->data[0]["title"]) ?></h2>
                                            <?php printf($agendas->data[0]["resume"]) ?>
                                        </div>
                                    </div>      
                                    
                                    <div class="row padding-left-10 padding-right-10 margin-bottom-40 listagem-noticias">
                                        <div class="col-lg-12  resumo">                                           
                                            <?php printf($agendas->data[0]["context"]) ?>
                                        </div>
                                    </div> 
